...
typedef struct HyPortLibrary {
    ...
    I_32  (PVMCALL port_isFunctionOverridden)(struct HyPortLibrary *portLibrary, UDATA offset) ;
    ...
    I_32  (PVMCALL error_last_error_number)(struct HyPortLibrary *portLibrary) ;
	/** see @ref hyerror.c::hyerror_last_error_message "hyerror_last_error_message"*/
    const char*  (PVMCALL error_last_error_message)(struct HyPortLibrary *portLibrary) ;
	/** see @ref hyerror.c::hyerror_set_last_error "hyerror_set_last_error"*/
    I_32  (PVMCALL error_set_last_error)(struct HyPortLibrary *portLibrary,  I_32 platformCode, I_32 portableCode) ;
	/** see @ref hyerror.c::hyerror_set_last_error_with_message "hyerror_set_last_error_with_message"*/
    I_32  (PVMCALL error_set_last_error_with_message)(struct HyPortLibrary *portLibrary, I_32 portableCode, const char *errorMessage) ;
    ...
    I_64  (PVMCALL time_current_time_millis)(struct HyPortLibrary *portLibrary) ;
    ...
    U_64  (PVMCALL time_hires_delta)(struct HyPortLibrary *portLibrary, U_64 startTime, U_64 endTime, UDATA requiredResolution) ;
    ...
    U_64  (PVMCALL sysinfo_get_physical_memory)(struct HyPortLibrary *portLibrary) ;
	/** see @ref hysysinfo.c::hysysinfo_get_OS_version "hysysinfo_get_OS_version"*/
    const char*  (PVMCALL sysinfo_get_OS_version)(struct HyPortLibrary *portLibrary) ;
	/** see @ref hysysinfo.c::hysysinfo_get_env "hysysinfo_get_env"*/
    IDATA  (PVMCALL sysinfo_get_env)(struct HyPortLibrary *portLibrary, char *envVar, char *infoString, UDATA bufSize) ;
	/** see @ref hysysinfo.c::hysysinfo_get_CPU_architecture "hysysinfo_get_CPU_architecture"*/
    const char*  (PVMCALL sysinfo_get_CPU_architecture)(struct HyPortLibrary *portLibrary) ;
	/** see @ref hysysinfo.c::hysysinfo_get_OS_type "hysysinfo_get_OS_type"*/
    const char*  (PVMCALL sysinfo_get_OS_type)(struct HyPortLibrary *portLibrary) ;
	/** see @ref hysysinfo.c::hysysinfo_get_classpathSeparator "hysysinfo_get_classpathSeparator"*/
    U_16  (PVMCALL sysinfo_get_classpathSeparator)(struct HyPortLibrary *portLibrary ) ;
	/** see @ref hysysinfo.c::hysysinfo_get_executable_name "hysysinfo_get_executable_name"*/
    IDATA  (PVMCALL sysinfo_get_executable_name)(struct HyPortLibrary *portLibrary, char *argv0, char **result) ;
	/** see @ref hysysinfo.c::hysysinfo_get_number_CPUs "hysysinfo_get_number_CPUs"*/
    UDATA  (PVMCALL sysinfo_get_number_CPUs)(struct HyPortLibrary *portLibrary) ;
	/** see @ref hysysinfo.c::hysysinfo_get_username "hysysinfo_get_username"*/
    IDATA  (PVMCALL sysinfo_get_username)(struct HyPortLibrary* portLibrary, char* buffer, UDATA length) ;
    ...
    IDATA  (PVMCALL file_write)(struct HyPortLibrary *portLibrary, IDATA fd, const void *buf, IDATA nbytes) ;
	/** see @ref hyfile.c::hyfile_write_text "hyfile_write_text"*/
    IDATA  (PVMCALL file_write_text)(struct HyPortLibrary *portLibrary, IDATA fd, const char *buf, IDATA nbytes) ;
	/** see @ref hyfile.c::hyfile_vprintf "hyfile_vprintf"*/
    void  (PVMCALL file_vprintf)(struct HyPortLibrary *portLibrary, IDATA fd, const char *format, va_list args) ;
	/** see @ref hyfile.c::hyfile_printf "hyfile_printf"*/
    void  (PVMCALL file_printf)(struct HyPortLibrary *portLibrary, IDATA fd, const char *format, ...) ;
	/** see @ref hyfile.c::hyfile_open "hyfile_open"*/
    IDATA  (PVMCALL file_open)(struct HyPortLibrary *portLibrary, const char *path, I_32 flags, I_32 mode) ;
    ...
    I_64  (PVMCALL file_seek)(struct HyPortLibrary *portLibrary, IDATA fd, I_64 offset, I_32 whence) ;
	/** see @ref hyfile.c::hyfile_read "hyfile_read"*/
    IDATA  (PVMCALL file_read)(struct HyPortLibrary *portLibrary, IDATA fd, void *buf, IDATA nbytes) ;
	/** see @ref hyfile.c::hyfile_unlink "hyfile_unlink"*/
    I_32  (PVMCALL file_unlink)(struct HyPortLibrary *portLibrary, const char *path) ;
	/** see @ref hyfile.c::hyfile_attr "hyfile_attr"*/
    I_32  (PVMCALL file_attr)(struct HyPortLibrary *portLibrary, const char *path) ;
	/** see @ref hyfile.c::hyfile_lastmod "hyfile_lastmod"*/
    I_64  (PVMCALL file_lastmod)(struct HyPortLibrary *portLibrary, const char *path) ;
	/** see @ref hyfile.c::hyfile_length "hyfile_length"*/
    I_64  (PVMCALL file_length)(struct HyPortLibrary *portLibrary, const char *path) ;
	/** see @ref hyfile.c::hyfile_set_length "hyfile_set_length"*/
    I_32  (PVMCALL file_set_length)(struct HyPortLibrary *portLibrary, IDATA fd, I_64 newLength) ;
    ...
    UDATA  (PVMCALL sl_close_shared_library)(struct HyPortLibrary *portLibrary, UDATA descriptor) ;
	/** see @ref hysl.c::hysl_open_shared_library "hysl_open_shared_library"*/
    UDATA  (PVMCALL sl_open_shared_library)(struct HyPortLibrary *portLibrary, char *name, UDATA *descriptor, BOOLEAN decorate) ;
	/** see @ref hysl.c::hysl_lookup_name "hysl_lookup_name"*/
    UDATA  (PVMCALL sl_lookup_name)(struct HyPortLibrary *portLibrary, UDATA descriptor, char *name, UDATA *func, const char *argSignature) ;
    ...
    void  (PVMCALL tty_printf)(struct HyPortLibrary *portLibrary, const char *format, ...) ;
	/** see @ref hytty.c::hytty_vprintf "hytty_vprintf"*/
    void  (PVMCALL tty_vprintf)(struct HyPortLibrary *portLibrary, const char *format, va_list args) ;
	/** see @ref hytty.c::hytty_get_chars "hytty_get_chars"*/
    IDATA  (PVMCALL tty_get_chars)(struct HyPortLibrary *portLibrary, char *s, UDATA length) ;
	/** see @ref hytty.c::hytty_err_printf "hytty_err_printf"*/
    void  (PVMCALL tty_err_printf)(struct HyPortLibrary *portLibrary, const char *format, ...) ;
	/** see @ref hytty.c::hytty_err_vprintf "hytty_err_vprintf"*/
    void  (PVMCALL tty_err_vprintf)(struct HyPortLibrary *portLibrary, const char *format, va_list args) ;
    ...
    I_32  (PVMCALL mem_startup)(struct HyPortLibrary *portLibrary, UDATA portGlobalSize) ;
    ...
    void*  (PVMCALL mem_allocate_memory)(struct HyPortLibrary *portLibrary, UDATA byteAmount) ;
	/** see @ref hymem.c::hymem_allocate_memory_callSite "hymem_allocate_memory_callSite"*/
    void*  (PVMCALL mem_allocate_memory_callSite)(struct HyPortLibrary *portLibrary, UDATA byteAmount, char *callSite) ;
	/** see @ref hymem.c::hymem_free_memory "hymem_free_memory"*/
    void  (PVMCALL mem_free_memory)(struct HyPortLibrary *portLibrary, void *memoryPointer) ;
	/** see @ref hymem.c::hymem_reallocate_memory "hymem_reallocate_memory"*/
    void*  (PVMCALL mem_reallocate_memory)(struct HyPortLibrary *portLibrary, void *memoryPointer, UDATA byteAmount) ;
    ...
    void  (PVMCALL cpu_flush_icache)(struct HyPortLibrary *portLibrary, void *memoryPointer, UDATA byteAmount) ;
    ...
    void*  (PVMCALL vmem_commit_memory)(struct HyPortLibrary *portLibrary, void *address, UDATA byteAmount, struct HyPortVmemIdentifier *identifier) ;
	/** see @ref hyvmem.c::hyvmem_decommit_memory "hyvmem_decommit_memory"*/
    IDATA  (PVMCALL vmem_decommit_memory)(struct HyPortLibrary *portLibrary, void *address, UDATA byteAmount, struct HyPortVmemIdentifier *identifier) ;
	/** see @ref hyvmem.c::hyvmem_free_memory "hyvmem_free_memory"*/
    I_32  (PVMCALL vmem_free_memory)(struct HyPortLibrary *portLibrary, void *userAddress, UDATA byteAmount, struct HyPortVmemIdentifier *identifier) ;
	/** see @ref hyvmem.c::hyvmem_reserve_memory "hyvmem_reserve_memory"*/
    void*  (PVMCALL vmem_reserve_memory)(struct HyPortLibrary *portLibrary, void *address, UDATA byteAmount, struct HyPortVmemIdentifier *identifier, UDATA mode, UDATA pageSize) ;
	/** see @ref hyvmem.c::hyvmem_supported_page_sizes "hyvmem_supported_page_sizes"*/
    UDATA*  (PVMCALL vmem_supported_page_sizes)(struct HyPortLibrary *portLibrary) ;
    ...
    I_32  (PVMCALL sock_write)(struct HyPortLibrary *portLibrary, hysocket_t sock, U_8 *buf, I_32 nbyte, I_32 flags) ;
	/** see @ref hysock.c::hysock_sockaddr "hysock_sockaddr"*/
    I_32  (PVMCALL sock_sockaddr)(struct HyPortLibrary *portLibrary, hysockaddr_t handle, char *addrStr, U_16 port) ;
	/** see @ref hysock.c::hysock_read "hysock_read"*/
    I_32  (PVMCALL sock_read)(struct HyPortLibrary *portLibrary, hysocket_t sock, U_8 *buf, I_32 nbyte, I_32 flags) ;
	/** see @ref hysock.c::hysock_socket "hysock_socket"*/
    I_32  (PVMCALL sock_socket)(struct HyPortLibrary *portLibrary, hysocket_t *handle, I_32 family, I_32 socktype,  I_32 protocol) ;
	/** see @ref hysock.c::hysock_close "hysock_close"*/
    I_32  (PVMCALL sock_close)(struct HyPortLibrary *portLibrary, hysocket_t *sock) ;
	/** see @ref hysock.c::hysock_connect "hysock_connect"*/
    I_32  (PVMCALL sock_connect)(struct HyPortLibrary *portLibrary, hysocket_t sock, hysockaddr_t addr) ;
	/** see @ref hysock.c::hysock_inetaddr "hysock_inetaddr"*/
    I_32  (PVMCALL sock_inetaddr)(struct HyPortLibrary *portLibrary, char *addrStr, U_32 *addr) ;
	/** see @ref hysock.c::hysock_gethostbyname "hysock_gethostbyname"*/
    I_32  (PVMCALL sock_gethostbyname)(struct HyPortLibrary *portLibrary, char *name, hyhostent_t handle) ;
	/** see @ref hysock.c::hysock_hostent_addrlist "hysock_hostent_addrlist"*/
    I_32  (PVMCALL sock_hostent_addrlist)(struct HyPortLibrary *portLibrary, hyhostent_t handle, U_32 index) ;
	/** see @ref hysock.c::hysock_sockaddr_init "hysock_sockaddr_init"*/
    I_32  (PVMCALL sock_sockaddr_init)(struct HyPortLibrary *portLibrary, hysockaddr_t handle, I_16 family, U_32 nipAddr, U_16 nPort) ;
	/** see @ref hysock.c::hysock_linger_init "hysock_linger_init"*/
    I_32  (PVMCALL sock_linger_init)(struct HyPortLibrary *portLibrary, hylinger_t handle, I_32 enabled, U_16 timeout) ;
	/** see @ref hysock.c::hysock_setopt_linger "hysock_setopt_linger"*/
    I_32  (PVMCALL sock_setopt_linger)(struct HyPortLibrary *portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname,  hylinger_t optval) ;
    ...
    UDATA  (PVMCALL gp_protect)(struct HyPortLibrary *portLibrary,  protected_fn fn, void* arg ) ;
	/** see @ref hygp.c::hygp_register_handler "hygp_register_handler"*/
    void  (PVMCALL gp_register_handler)(struct HyPortLibrary *portLibrary, handler_fn fn, void *aUserData ) ;
	/** see @ref hygp.c::hygp_info "hygp_info"*/
    U_32  (PVMCALL gp_info)(struct HyPortLibrary *portLibrary, void *info, U_32 category, I_32 index, const char **name, void **value) ;
	/** see @ref hygp.c::hygp_info_count "hygp_info_count"*/
    U_32  (PVMCALL gp_info_count)(struct HyPortLibrary *portLibrary, void *info, U_32 category) ;
    ...
    U_32  (PVMCALL str_printf)(struct HyPortLibrary *portLibrary, char *buf, U_32 bufLen, const char* format, ...) ;
	/** see @ref hystr.c::hystr_vprintf "hystr_vprintf"*/
    U_32  (PVMCALL str_vprintf)(struct HyPortLibrary *portLibrary, char *buf, U_32 bufLen, const char *format, va_list args) ;
    ...
    void  (PVMCALL exit_shutdown_and_exit)(struct HyPortLibrary *portLibrary, I_32 exitCode) ;
	/** self_handle*/
    void* self_handle;
	/** see @ref hydump.c::hydump_create "hydump_create"*/
    UDATA  (PVMCALL dump_create)(struct HyPortLibrary *portLibrary, char *filename, char *dumpType, void *userData) ;
    ...
    void  (PVMCALL nls_set_catalog)( struct HyPortLibrary *portLibrary, const char **paths, const int nPaths, const char* baseName, const char* extension ) ;
	/** see @ref hynls.c::hynls_set_locale "hynls_set_locale"*/
    void  (PVMCALL nls_set_locale)( struct HyPortLibrary *portLibrary, const char* lang, const char* region, const char* variant ) ;
    ...
    void  (PVMCALL nls_printf)( struct HyPortLibrary *portLibrary, UDATA flags, U_32 module_name, U_32 message_num, ... ) ;
	/** see @ref hynls.c::hynls_vprintf "hynls_vprintf"*/
    void  (PVMCALL nls_vprintf)( struct HyPortLibrary *portLibrary, UDATA flags, U_32 module_name, U_32 message_num, va_list args ) ;
	/** see @ref hynls.c::hynls_lookup_message "hynls_lookup_message"*/
    const char*  (PVMCALL nls_lookup_message)( struct HyPortLibrary *portLibrary, UDATA flags, U_32 module_name, U_32 message_num, const char *default_string ) ;
    ...
    I_32  (PVMCALL ipcmutex_acquire)(struct HyPortLibrary *portLibrary, const char *name) ;
	/** see @ref hyipcmutex.c::hyipcmutex_release "hyipcmutex_release"*/
    I_32  (PVMCALL ipcmutex_release)(struct HyPortLibrary *portLibrary, const char *name) ;
	/** see @ref hyportcontrol.c::hyport_control "hyport_control"*/
    I_32  (PVMCALL port_control)( struct HyPortLibrary *portLibrary, char *key, UDATA value) ;
    ...
    I_32  (PVMCALL sig_protect)(struct HyPortLibrary *portLibrary,  hysig_protected_fn fn, void* fn_arg, hysig_handler_fn handler, void* handler_arg, U_32 flags, UDATA *result ) ;
	/** see @ref hysig.c::hysig_can_protect "hysig_can_protect"*/
    I_32  (PVMCALL sig_can_protect)(struct HyPortLibrary *portLibrary,  U_32 flags) ;
	/** see @ref hysig.c::hysig_set_async_signal_handler "hysig_set_async_signal_handler"*/
    U_32  (PVMCALL sig_set_async_signal_handler)(struct HyPortLibrary* portLibrary,  hysig_handler_fn handler, void* handler_arg, U_32 flags) ;
	/** see @ref hysig.c::hysig_info "hysig_info"*/
    U_32  (PVMCALL sig_info)(struct HyPortLibrary *portLibrary, void *info, U_32 category, I_32 index, const char **name, void **value) ;
	/** see @ref hysig.c::hysig_info_count "hysig_info_count"*/
    U_32  (PVMCALL sig_info_count)(struct HyPortLibrary *portLibrary, void *info, U_32 category) ;
	/** see @ref hysig.c::hysig_set_options "hysig_set_options"*/
    I_32  (PVMCALL sig_set_options)(struct HyPortLibrary *portLibrary, U_32 options) ;
    ...
    UDATA  (PVMCALL sysinfo_DLPAR_enabled)(struct HyPortLibrary *portLibrary) ;
	/** see @ref hysysinfo.c::hysysinfo_DLPAR_max_CPUs "hysysinfo_DLPAR_max_CPUs"*/
    UDATA  (PVMCALL sysinfo_DLPAR_max_CPUs)(struct HyPortLibrary *portLibrary) ;
	/** see @ref hysysinfo.c::hysysinfo_weak_memory_consistency "hysysinfo_weak_memory_consistency"*/
    UDATA  (PVMCALL sysinfo_weak_memory_consistency)(struct HyPortLibrary *portLibrary) ;
	/** see @ref hyfile.c::hyfile_read_text "hyfile_read_text"*/
    char*  (PVMCALL file_read_text)(struct HyPortLibrary *portLibrary, IDATA fd, char *buf, IDATA nbytes) ;
	/** see @ref hyfile.c::hyfile_mkdir "hyfile_mkdir"*/
    I_32  (PVMCALL file_mkdir)(struct HyPortLibrary *portLibrary, const char *path) ;
	/** see @ref hyfile.c::hyfile_move "hyfile_move"*/
    I_32  (PVMCALL file_move)(struct HyPortLibrary *portLibrary, const char *pathExist, const char *pathNew) ;
	/** see @ref hyfile.c::hyfile_unlinkdir "hyfile_unlinkdir"*/
    I_32  (PVMCALL file_unlinkdir)(struct HyPortLibrary *portLibrary, const char *path) ;
	/** see @ref hyfile.c::hyfile_findfirst "hyfile_findfirst"*/
    UDATA  (PVMCALL file_findfirst)(struct HyPortLibrary *portLibrary, const char *path, char *resultbuf) ;
	/** see @ref hyfile.c::hyfile_findnext "hyfile_findnext"*/
    I_32  (PVMCALL file_findnext)(struct HyPortLibrary *portLibrary, UDATA findhandle, char *resultbuf) ;
	/** see @ref hyfile.c::hyfile_findclose "hyfile_findclose"*/
    void  (PVMCALL file_findclose)(struct HyPortLibrary *portLibrary, UDATA findhandle) ;
	/** see @ref hyfile.c::hyfile_error_message "hyfile_error_message"*/
    const char*  (PVMCALL file_error_message)(struct HyPortLibrary *portLibrary) ;
    ...
    I_32  (PVMCALL sock_bind)(struct HyPortLibrary *portLibrary, hysocket_t sock, hysockaddr_t addr) ;
	/** see @ref hysock.c::hysock_accept "hysock_accept"*/
    I_32  (PVMCALL sock_accept)(struct HyPortLibrary *portLibrary, hysocket_t serverSock, hysockaddr_t addrHandle, hysocket_t *sockHandle) ;
	/** see @ref hysock.c::hysock_shutdown_input "hysock_shutdown_input"*/
    I_32  (PVMCALL sock_shutdown_input)(struct HyPortLibrary *portLibrary, hysocket_t sock) ;
	/** see @ref hysock.c::hysock_shutdown_output "hysock_shutdown_output"*/
    I_32  (PVMCALL sock_shutdown_output)(struct HyPortLibrary *portLibrary, hysocket_t sock) ;
	/** see @ref hysock.c::hysock_listen "hysock_listen"*/
    I_32  (PVMCALL sock_listen)(struct HyPortLibrary *portLibrary, hysocket_t sock, I_32 backlog ) ;
    ...
    I_32  (PVMCALL sock_getpeername)(struct HyPortLibrary *portLibrary, hysocket_t handle, hysockaddr_t addrHandle) ;
	/** see @ref hysock.c::hysock_getsockname "hysock_getsockname"*/
    I_32  (PVMCALL sock_getsockname)(struct HyPortLibrary *portLibrary, hysocket_t handle, hysockaddr_t addrHandle) ;
	/** see @ref hysock.c::hysock_readfrom "hysock_readfrom"*/
    I_32  (PVMCALL sock_readfrom)(struct HyPortLibrary *portLibrary, hysocket_t sock, U_8 *buf, I_32 nbyte, I_32 flags, hysockaddr_t addrHandle) ;
	/** see @ref hysock.c::hysock_select "hysock_select"*/
    I_32  (PVMCALL sock_select)(struct HyPortLibrary *portLibrary, I_32 nfds, hyfdset_t readfds, hyfdset_t writefds, hyfdset_t exceptfds, hytimeval_t timeout) ;
	/** see @ref hysock.c::hysock_writeto "hysock_writeto"*/
    I_32  (PVMCALL sock_writeto)(struct HyPortLibrary *portLibrary, hysocket_t sock, U_8 *buf, I_32 nbyte, I_32 flags, hysockaddr_t addrHandle) ;
	/** see @ref hysock.c::hysock_inetntoa "hysock_inetntoa"*/
    I_32  (PVMCALL sock_inetntoa)(struct HyPortLibrary *portLibrary, char **addrStr, U_32 nipAddr) ;
	/** see @ref hysock.c::hysock_gethostbyaddr "hysock_gethostbyaddr"*/
    I_32  (PVMCALL sock_gethostbyaddr)(struct HyPortLibrary *portLibrary, char *addr, I_32 length, I_32 type, hyhostent_t handle) ;
	/** see @ref hysock.c::hysock_gethostname "hysock_gethostname"*/
    I_32  (PVMCALL sock_gethostname)(struct HyPortLibrary *portLibrary, char *buffer, I_32 length) ;
	/** see @ref hysock.c::hysock_hostent_aliaslist "hysock_hostent_aliaslist"*/
    I_32  (PVMCALL sock_hostent_aliaslist)(struct HyPortLibrary *portLibrary, hyhostent_t handle, char ***aliasList) ;
	/** see @ref hysock.c::hysock_hostent_hostname "hysock_hostent_hostname"*/
    I_32  (PVMCALL sock_hostent_hostname)(struct HyPortLibrary *portLibrary, hyhostent_t handle, char** hostName) ;
	/** see @ref hysock.c::hysock_sockaddr_port "hysock_sockaddr_port"*/
    U_16  (PVMCALL sock_sockaddr_port)(struct HyPortLibrary *portLibrary, hysockaddr_t handle) ;
	/** see @ref hysock.c::hysock_sockaddr_address "hysock_sockaddr_address"*/
    I_32  (PVMCALL sock_sockaddr_address)(struct HyPortLibrary *portLibrary, hysockaddr_t handle) ;
	/** see @ref hysock.c::hysock_fdset_init "hysock_fdset_init"*/
    I_32  (PVMCALL sock_fdset_init)(struct HyPortLibrary *portLibrary, hysocket_t socketP) ;
	/** see @ref hysock.c::hysock_fdset_size "hysock_fdset_size"*/
    I_32  (PVMCALL sock_fdset_size)(struct HyPortLibrary *portLibrary, hysocket_t handle) ;
	/** see @ref hysock.c::hysock_timeval_init "hysock_timeval_init"*/
    I_32  (PVMCALL sock_timeval_init)(struct HyPortLibrary *portLibrary, U_32 secTime, U_32 uSecTime, hytimeval_t timeP) ;
	/** see @ref hysock.c::hysock_getopt_int "hysock_getopt_int"*/
    I_32  (PVMCALL sock_getopt_int)(struct HyPortLibrary *portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname,  I_32 *optval) ;
	/** see @ref hysock.c::hysock_setopt_int "hysock_setopt_int"*/
    I_32  (PVMCALL sock_setopt_int)(struct HyPortLibrary *portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname,  I_32 *optval) ;
	/** see @ref hysock.c::hysock_getopt_bool "hysock_getopt_bool"*/
    I_32  (PVMCALL sock_getopt_bool)(struct HyPortLibrary *portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname,  BOOLEAN *optval) ;
	/** see @ref hysock.c::hysock_setopt_bool "hysock_setopt_bool"*/
    I_32  (PVMCALL sock_setopt_bool)(struct HyPortLibrary *portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname,  BOOLEAN *optval) ;
	/** see @ref hysock.c::hysock_getopt_byte "hysock_getopt_byte"*/
    I_32  (PVMCALL sock_getopt_byte)(struct HyPortLibrary *portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname,  U_8 *optval) ;
	/** see @ref hysock.c::hysock_setopt_byte "hysock_setopt_byte"*/
    I_32  (PVMCALL sock_setopt_byte)(struct HyPortLibrary *portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname,  U_8 *optval) ;
	/** see @ref hysock.c::hysock_getopt_linger "hysock_getopt_linger"*/
    I_32  (PVMCALL sock_getopt_linger)(struct HyPortLibrary *portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname,  hylinger_t optval) ;
	/** see @ref hysock.c::hysock_getopt_sockaddr "hysock_getopt_sockaddr"*/
    I_32  (PVMCALL sock_getopt_sockaddr)(struct HyPortLibrary *portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname, hysockaddr_t optval) ;
	/** see @ref hysock.c::hysock_setopt_sockaddr "hysock_setopt_sockaddr"*/
    I_32  (PVMCALL sock_setopt_sockaddr)(struct HyPortLibrary *portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname,  hysockaddr_t optval) ;
	/** see @ref hysock.c::hysock_setopt_ipmreq "hysock_setopt_ipmreq"*/
    I_32  (PVMCALL sock_setopt_ipmreq)(struct HyPortLibrary *portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname,  hyipmreq_t optval) ;
	/** see @ref hysock.c::hysock_linger_enabled "hysock_linger_enabled"*/
    I_32  (PVMCALL sock_linger_enabled)(struct HyPortLibrary *portLibrary, hylinger_t handle, BOOLEAN *enabled) ;
	/** see @ref hysock.c::hysock_linger_linger "hysock_linger_linger"*/
    I_32  (PVMCALL sock_linger_linger)(struct HyPortLibrary *portLibrary, hylinger_t handle, U_16 *linger) ;
	/** see @ref hysock.c::hysock_ipmreq_init "hysock_ipmreq_init"*/
    I_32  (PVMCALL sock_ipmreq_init)(struct HyPortLibrary *portLibrary, hyipmreq_t handle, U_32 nipmcast, U_32 nipinterface) ;
	/** see @ref hysock.c::hysock_setflag "hysock_setflag"*/
    I_32  (PVMCALL sock_setflag)(struct HyPortLibrary *portLibrary, I_32 flag, I_32 *arg) ;
	/** see @ref hysock.c::hysock_freeaddrinfo "hysock_freeaddrinfo"*/
    I_32  (PVMCALL sock_freeaddrinfo)(struct HyPortLibrary *portLibrary, hyaddrinfo_t handle) ;
	/** see @ref hysock.c::hysock_getaddrinfo "hysock_getaddrinfo"*/
    I_32  (PVMCALL sock_getaddrinfo)(struct HyPortLibrary *portLibrary, char *name, hyaddrinfo_t hints, hyaddrinfo_t result) ;
	/** see @ref hysock.c::hysock_getaddrinfo_address "hysock_getaddrinfo_address"*/
    I_32  (PVMCALL sock_getaddrinfo_address)(struct HyPortLibrary *portLibrary, hyaddrinfo_t handle, U_8 *address, int index, U_32* scope_id) ;
	/** see @ref hysock.c::hysock_getaddrinfo_create_hints "hysock_getaddrinfo_create_hints"*/
    I_32  (PVMCALL sock_getaddrinfo_create_hints)(struct HyPortLibrary *portLibrary, hyaddrinfo_t *result, I_16 family, I_32 socktype, I_32 protocol, I_32 flags) ;
	/** see @ref hysock.c::hysock_getaddrinfo_family "hysock_getaddrinfo_family"*/
    I_32  (PVMCALL sock_getaddrinfo_family)(struct HyPortLibrary *portLibrary, hyaddrinfo_t handle, I_32 *family, int index) ;
	/** see @ref hysock.c::hysock_getaddrinfo_length "hysock_getaddrinfo_length"*/
    I_32  (PVMCALL sock_getaddrinfo_length)(struct HyPortLibrary *portLibrary, hyaddrinfo_t handle, I_32 *length) ;
	/** see @ref hysock.c::hysock_getaddrinfo_name "hysock_getaddrinfo_name"*/
    I_32  (PVMCALL sock_getaddrinfo_name)(struct HyPortLibrary *portLibrary, hyaddrinfo_t handle, char *name, int index) ;
	/** see @ref hysock.c::hysock_getnameinfo "hysock_getnameinfo"*/
    I_32  (PVMCALL sock_getnameinfo)(struct HyPortLibrary *portLibrary, hysockaddr_t in_addr, I_32 sockaddr_size, char *name, I_32 name_length, int flags) ;
	/** see @ref hysock.c::hysock_ipv6_mreq_init "hysock_ipv6_mreq_init"*/
    I_32  (PVMCALL sock_ipv6_mreq_init)(struct HyPortLibrary *portLibrary, hyipv6_mreq_t handle, U_8 *ipmcast_addr, U_32 ipv6mr_interface) ;
	/** see @ref hysock.c::hysock_setopt_ipv6_mreq "hysock_setopt_ipv6_mreq"*/
    I_32  (PVMCALL sock_setopt_ipv6_mreq)(struct HyPortLibrary *portLibrary, hysocket_t socketP, I_32 optlevel, I_32 optname,  hyipv6_mreq_t optval) ;
	/** see @ref hysock.c::hysock_sockaddr_address6 "hysock_sockaddr_address6"*/
    I_32  (PVMCALL sock_sockaddr_address6)(struct HyPortLibrary *portLibrary, hysockaddr_t handle, U_8 *address, U_32 *length, U_32* scope_id) ;
	/** see @ref hysock.c::hysock_sockaddr_family "hysock_sockaddr_family"*/
    I_32  (PVMCALL sock_sockaddr_family)(struct HyPortLibrary *portLibrary, I_16 *family, hysockaddr_t handle) ;
	/** see @ref hysock.c::hysock_sockaddr_init6 "hysock_sockaddr_init6"*/
    I_32  (PVMCALL sock_sockaddr_init6)(struct HyPortLibrary *portLibrary, hysockaddr_t handle, U_8 *addr, I_32 addrlength, I_16 family, U_16 nPort,U_32 flowinfo, U_32 scope_id, hysocket_t sock) ;
	/** see @ref hysock.c::hysock_socketIsValid "hysock_socketIsValid"*/
    I_32  (PVMCALL sock_socketIsValid)(struct HyPortLibrary *portLibrary, hysocket_t handle) ;
	/** see @ref hysock.c::hysock_select_read "hysock_select_read"*/
    I_32  (PVMCALL sock_select_read)(struct HyPortLibrary *portLibrary, hysocket_t hysocketP, I_32 secTime, I_32 uSecTime, BOOLEAN accept) ;
	/** see @ref hysock.c::hysock_set_nonblocking "hysock_set_nonblocking"*/
    I_32  (PVMCALL sock_set_nonblocking)(struct HyPortLibrary *portLibrary, hysocket_t socketP, BOOLEAN nonblocking) ;
	/** see @ref hysock.c::hysock_error_message "hysock_error_message"*/
    const char*  (PVMCALL sock_error_message)(struct HyPortLibrary *portLibrary) ;
	/** see @ref hysock.c::hysock_get_network_interfaces "hysock_get_network_interfaces"*/
    I_32  (PVMCALL sock_get_network_interfaces)(struct HyPortLibrary *portLibrary, struct hyNetworkInterfaceArray_struct *array,BOOLEAN preferIPv4Stack) ;
	/** see @ref hysock.c::hysock_free_network_interface_struct "hysock_free_network_interface_struct"*/
    I_32  (PVMCALL sock_free_network_interface_struct)(struct HyPortLibrary *portLibrary, struct hyNetworkInterfaceArray_struct* array) ;
	/** see @ref hysock.c::hysock_connect_with_timeout "hysock_connect_with_timeout"*/
    I_32  (PVMCALL sock_connect_with_timeout)(struct HyPortLibrary *portLibrary, hysocket_t sock, hysockaddr_t addr, U_32 timeout, U_32 step, U_8** context) ;
	/** see @ref hystr.c::hystr_ftime "hystr_ftime"*/
    U_32  (PVMCALL str_ftime)(struct HyPortLibrary *portLibrary, char *buf, U_32 bufLen, const char *format) ;
    ...
    void*  (PVMCALL mmap_map_file)(struct HyPortLibrary *portLibrary, const char *path, void **handle) ;
	/** see @ref hymmap.c::hymmap_unmap_file "hymmap_unmap_file"*/
    void  (PVMCALL mmap_unmap_file)(struct HyPortLibrary *portLibrary, void *handle) ;
    ...
    IDATA  (PVMCALL shsem_open)(struct HyPortLibrary *portLibrary, struct hyshsem_handle** handle, const char* semname, int setSize, int permission) ;
	/** see @ref hyshsem.c::hyshsem_post "hyshsem_post"*/
    IDATA  (PVMCALL shsem_post)(struct HyPortLibrary *portLibrary, struct hyshsem_handle* handle, UDATA semset, UDATA flag) ;
	/** see @ref hyshsem.c::hyshsem_wait "hyshsem_wait"*/
    IDATA  (PVMCALL shsem_wait)(struct HyPortLibrary *portLibrary, struct hyshsem_handle* handle, UDATA semset, UDATA flag) ;
	/** see @ref hyshsem.c::hyshsem_getVal "hyshsem_getVal"*/
    IDATA  (PVMCALL shsem_getVal)(struct HyPortLibrary *portLibrary, struct hyshsem_handle* handle, UDATA semset) ;
	/** see @ref hyshsem.c::hyshsem_setVal "hyshsem_setVal"*/
    IDATA  (PVMCALL shsem_setVal)(struct HyPortLibrary *portLibrary, struct hyshsem_handle* handle, UDATA semset, IDATA value) ;
	/** see @ref hyshsem.c::hyshsem_close "hyshsem_close"*/
    void  (PVMCALL shsem_close)(struct HyPortLibrary *portLibrary, struct hyshsem_handle **handle) ;
	/** see @ref hyshsem.c::hyshsem_destroy "hyshsem_destroy"*/
    IDATA  (PVMCALL shsem_destroy)(struct HyPortLibrary *portLibrary, struct hyshsem_handle **handle) ;
    ...
    IDATA  (PVMCALL shmem_open)(struct HyPortLibrary *portLibrary, struct hyshmem_handle **handle, const char* rootname, I_32 size, I_32 perm) ;
	/** see @ref hyshmem.c::hyshmem_attach "hyshmem_attach"*/
    void*  (PVMCALL shmem_attach)(struct HyPortLibrary *portLibrary, struct hyshmem_handle* handle) ;
	/** see @ref hyshmem.c::hyshmem_detach "hyshmem_detach"*/
    IDATA  (PVMCALL shmem_detach)(struct HyPortLibrary *portLibrary, struct hyshmem_handle **handle) ;
	/** see @ref hyshmem.c::hyshmem_close "hyshmem_close"*/
    void  (PVMCALL shmem_close)(struct HyPortLibrary *portLibrary, struct hyshmem_handle **handle) ;
	/** see @ref hyshmem.c::hyshmem_destroy "hyshmem_destroy"*/
    IDATA  (PVMCALL shmem_destroy)(struct HyPortLibrary *portLibrary, struct hyshmem_handle **handle) ;
	/** see @ref hyshmem.c::hyshmem_findfirst "hyshmem_findfirst"*/
    UDATA  (PVMCALL shmem_findfirst)(struct HyPortLibrary *portLibrary, char *resultbuf) ;
	/** see @ref hyshmem.c::hyshmem_findnext "hyshmem_findnext"*/
    I_32  (PVMCALL shmem_findnext)(struct HyPortLibrary *portLibrary, UDATA findhandle, char *resultbuf) ;
	/** see @ref hyshmem.c::hyshmem_findclose "hyshmem_findclose"*/
    void  (PVMCALL shmem_findclose)(struct HyPortLibrary *portLibrary, UDATA findhandle) ;
	/** see @ref hyshmem.c::hyshmem_stat "hyshmem_stat"*/
    UDATA  (PVMCALL shmem_stat)(struct HyPortLibrary *portLibrary, const char* name, struct HyPortShmemStatistic* statbuf) ;
	/** see @ref hysysinfo.c::hysysinfo_get_processing_capacity "hysysinfo_get_processing_capacity"*/
    UDATA  (PVMCALL sysinfo_get_processing_capacity)(struct HyPortLibrary *portLibrary) ;
...
extern HY_CFUNC I_32 VMCALL hyport_create_library(struct HyPortLibrary *portLibrary, struct HyPortLibraryVersion *version, UDATA size);
extern HY_CFUNC I_32 VMCALL hyport_init_library(struct HyPortLibrary*portLibrary, struct HyPortLibraryVersion *version, UDATA size);
extern HY_CFUNC I_32 VMCALL hyport_shutdown_library(struct HyPortLibrary *portLibrary);
extern HY_CFUNC I_32 VMCALL hyport_startup_library(struct HyPortLibrary *portLibrary);
/** Port library self allocation routines */
extern HY_CFUNC I_32 VMCALL hyport_allocate_library(struct HyPortLibraryVersion *expectedVersion, struct HyPortLibrary **portLibrary);
 ...
 * @{
 */
extern HY_CFUNC UDATA VMCALL hyport_getSize(struct HyPortLibraryVersion *version);
extern HY_CFUNC I_32 VMCALL hyport_getVersion(struct HyPortLibrary *portLibrary, struct HyPortLibraryVersion *version);
extern HY_CFUNC I_32 VMCALL hyport_isCompatible(struct HyPortLibraryVersion *expectedVersion);
/** @} */
/** 
