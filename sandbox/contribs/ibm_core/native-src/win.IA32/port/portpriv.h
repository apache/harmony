...
extern HY_CFUNC void VMCALL hycpu_flush_icache
PROTOTYPE ((struct HyPortLibrary * portLibrary, void *memoryPointer,
	    UDATA byteAmount));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hycpu_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hycpu_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));

/* HySourceHyError*/
struct HyPortLibrary;
extern HY_CFUNC const char *VMCALL hyerror_last_error_message
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyerror_set_last_error
PROTOTYPE ((struct HyPortLibrary * portLibrary, I_32 platformCode,
	    I_32 portableCode));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyerror_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyerror_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyerror_set_last_error_with_message
PROTOTYPE ((struct HyPortLibrary * portLibrary, I_32 portableCode,
	    const char *errorMessage));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyerror_last_error_number
PROTOTYPE ((struct HyPortLibrary * portLibrary));

/* HySourceHyErrorHelpers*/
struct HyPortLibrary;
extern HY_CFUNC const char *VMCALL errorMessage
PROTOTYPE ((struct HyPortLibrary * portLibrary, I_32 errorCode));

/* HySourceHyExit*/
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyexit_get_exit_code
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyexit_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyexit_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyexit_shutdown_and_exit
PROTOTYPE ((struct HyPortLibrary * portLibrary, I_32 exitCode));

/* HySourceHyFile*/
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyfile_unlink
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *path));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyfile_close
PROTOTYPE ((struct HyPortLibrary * portLibrary, IDATA fd));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyfile_mkdir
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *path));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyfile_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyfile_set_length
PROTOTYPE ((struct HyPortLibrary * portLibrary, IDATA fd, I_64 newLength));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyfile_findnext
...
PROTOTYPE ((struct HyPortLibrary * portLibrary, IDATA fd));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyfile_vprintf
PROTOTYPE ((struct HyPortLibrary * portLibrary, IDATA fd, const char *format,
	    va_list args));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyfile_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyfile_printf
PROTOTYPE ((struct HyPortLibrary * portLibrary, IDATA fd, const char *format,
	    ...));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyfile_unlinkdir
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *path));
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hyfile_open
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *path, I_32 flags,
	    I_32 mode));
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hyfile_findfirst
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *path,
	    char *resultbuf));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyfile_move
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *pathExist,
	    const char *pathNew));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyfile_attr
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *path));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyfile_findclose
PROTOTYPE ((struct HyPortLibrary * portLibrary, UDATA findhandle));
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hyfile_read
PROTOTYPE ((struct HyPortLibrary * portLibrary, IDATA fd, void *buf,
	    IDATA nbytes));
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hyfile_write
PROTOTYPE ((struct HyPortLibrary * portLibrary, IDATA fd, const void *buf,
	    IDATA nbytes));
struct HyPortLibrary;
extern HY_CFUNC const char *VMCALL hyfile_error_message
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_64 VMCALL hyfile_seek
PROTOTYPE ((struct HyPortLibrary * portLibrary, IDATA fd, I_64 offset,
	    I_32 whence));
struct HyPortLibrary;
extern HY_CFUNC I_64 VMCALL hyfile_length
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *path));
struct HyPortLibrary;
extern HY_CFUNC I_64 VMCALL hyfile_lastmod
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *path));

/* HySourceHyFileText*/
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hyfile_write_text
PROTOTYPE ((struct HyPortLibrary * portLibrary, IDATA fd, const char *buf,
	    IDATA nbytes));
struct HyPortLibrary;
extern HY_CFUNC char *VMCALL hyfile_read_text
PROTOTYPE ((struct HyPortLibrary * portLibrary, IDATA fd, char *buf,
	    IDATA nbytes));

/* HySourceHyGP*/
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hygp_register_handler
PROTOTYPE ((struct HyPortLibrary * portLibrary, handler_fn fn,
	    void *aUserData));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hygp_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hygp_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hygp_protect
PROTOTYPE ((struct HyPortLibrary * portLibrary, protected_fn fn, void *arg));
struct HyPortLibrary;
extern HY_CFUNC U_32 VMCALL hygp_info_count
PROTOTYPE ((struct HyPortLibrary * portLibrary, void *info, U_32 category));
struct HyPortLibrary;
extern HY_CFUNC U_32 VMCALL hygp_info
PROTOTYPE ((struct HyPortLibrary * portLibrary, void *info, U_32 category,
	    I_32 index, const char **name, void **value));

/* HySourceHyIPCMutex*/
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyipcmutex_release
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *name));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyipcmutex_acquire
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *name));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyipcmutex_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyipcmutex_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));

/* HySourceHyMem*/
extern HY_CFUNC void VMCALL hymem_deallocate_portLibrary
PROTOTYPE ((void *memoryPointer));
struct HyPortLibrary;
extern HY_CFUNC void *VMCALL hymem_allocate_memory
PROTOTYPE ((struct HyPortLibrary * portLibrary, UDATA byteAmount));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hymem_startup
...
struct HyPortLibrary;
extern HY_CFUNC void *VMCALL hymem_reallocate_memory
PROTOTYPE ((struct HyPortLibrary * portLibrary, void *memoryPointer,
	    UDATA byteAmount));
struct HyPortLibrary;
extern HY_CFUNC void *VMCALL hymem_allocate_memory_callSite
PROTOTYPE ((struct HyPortLibrary * portLibrary, UDATA byteAmount,
	    char *callSite));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hymem_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hymem_free_memory
PROTOTYPE ((struct HyPortLibrary * portLibrary, void *memoryPointer));

/* HySourceHyMemoryMap*/
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hymmap_unmap_file
PROTOTYPE ((struct HyPortLibrary * portLibrary, void *handle));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hymmap_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hymmap_capabilities
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void *VMCALL hymmap_map_file
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *path,
	    void **handle));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hymmap_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));

/* HySourceHyNLS*/
struct HyPortLibrary;
extern HY_CFUNC const char *VMCALL hynls_get_language
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC const char *VMCALL hynls_get_variant
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hynls_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hynls_vprintf
PROTOTYPE ((struct HyPortLibrary * portLibrary, UDATA flags, U_32 module_name,
	    U_32 message_num, va_list args));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hynls_set_catalog
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char **paths,
	    const int nPaths, const char *baseName, const char *extension));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hynls_set_locale
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *lang,
	    const char *region, const char *variant));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hynls_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hynls_printf
PROTOTYPE ((struct HyPortLibrary * portLibrary, UDATA flags, U_32 module_name,
	    U_32 message_num, ...));
struct HyPortLibrary;
extern HY_CFUNC const char *VMCALL hynls_lookup_message
PROTOTYPE ((struct HyPortLibrary * portLibrary, UDATA flags, U_32 module_name,
	    U_32 message_num, const char *default_string));
struct HyPortLibrary;
extern HY_CFUNC const char *VMCALL hynls_get_region
PROTOTYPE ((struct HyPortLibrary * portLibrary));

/* HySourceHyNLSHelpers*/
struct HyPortLibrary;
extern HY_CFUNC void nls_determine_locale
PROTOTYPE ((struct HyPortLibrary * portLibrary));

/* HySourceHyOSDump*/
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hydump_create
PROTOTYPE ((struct HyPortLibrary * portLibrary, char *filename,
	    char *dumpType, void *userData));

/* HySourceHyPortControl*/
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyport_control
...
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyport_tls_free
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyport_tls_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void *VMCALL hyport_tls_peek
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void *VMCALL hyport_tls_get
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyport_tls_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));

/* HySourceHySharedMemory*/
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyshmem_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyshmem_findnext
PROTOTYPE ((struct HyPortLibrary * portLibrary, UDATA findhandle,
	    char *resultbuf));
struct hyshmem_handle;
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hyshmem_detach
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct hyshmem_handle ** handle));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyshmem_findclose
PROTOTYPE ((struct HyPortLibrary * portLibrary, UDATA findhandle));
struct hyshmem_handle;
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyshmem_close
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct hyshmem_handle ** handle));
struct HyPortLibrary;
struct hyshmem_handle;
extern HY_CFUNC void *VMCALL hyshmem_attach
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct hyshmem_handle * handle));
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hyshmem_findfirst
PROTOTYPE ((struct HyPortLibrary * portLibrary, char *resultbuf));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyshmem_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortShmemStatistic;
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hyshmem_stat
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *name,
	    struct HyPortShmemStatistic * statbuf));
struct hyshmem_handle;
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hyshmem_destroy
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct hyshmem_handle ** handle));
struct hyshmem_handle;
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hyshmem_open
PROTOTYPE ((struct HyPortLibrary * portLibrary,
...
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyshsem_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
struct hyshsem_handle;
extern HY_CFUNC void VMCALL hyshsem_close
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct hyshsem_handle ** handle));
struct hyshsem_handle;
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hyshsem_post
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct hyshsem_handle * handle, UDATA semset, UDATA flag));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyshsem_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
struct hyshsem_handle;
extern HY_CFUNC IDATA VMCALL hyshsem_destroy
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct hyshsem_handle ** handle));
struct hyshsem_handle;
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hyshsem_setVal
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct hyshsem_handle * handle, UDATA semset, IDATA value));
struct hyshsem_handle;
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hyshsem_open
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct hyshsem_handle ** handle, const char *semname, int setSize,
	    int permission));
struct hyshsem_handle;
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hyshsem_getVal
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct hyshsem_handle * handle, UDATA semset));
struct hyshsem_handle;
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hyshsem_wait
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct hyshsem_handle * handle, UDATA semset, UDATA flag));

/* HySourceHySI*/
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hysysinfo_get_executable_name
PROTOTYPE ((struct HyPortLibrary * portLibrary, char *argv0, char **result));
struct HyPortLibrary;
extern HY_CFUNC const char *VMCALL hysysinfo_get_OS_type
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC U_64 VMCALL hysysinfo_get_physical_memory
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hysysinfo_DLPAR_max_CPUs
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hysysinfo_get_number_CPUs
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC const char *VMCALL hysysinfo_get_CPU_architecture
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hysysinfo_get_processing_capacity
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC const char *VMCALL hysysinfo_get_OS_version
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysysinfo_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hysysinfo_DLPAR_enabled
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hysysinfo_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hysysinfo_get_pid
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC U_16 VMCALL hysysinfo_get_classpathSeparator
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hysysinfo_get_username
PROTOTYPE ((struct HyPortLibrary * portLibrary, char *buffer, UDATA length));
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hysysinfo_weak_memory_consistency
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hysysinfo_get_env
PROTOTYPE ((struct HyPortLibrary * portLibrary, char *envVar,
	    char *infoString, UDATA bufSize));

/* HySourceHySignal*/
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysig_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC U_32 VMCALL hysig_get_options
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysig_can_protect
PROTOTYPE ((struct HyPortLibrary * portLibrary, U_32 flags));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hysig_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC U_32 VMCALL hysig_info_count
PROTOTYPE ((struct HyPortLibrary * portLibrary, void *info, U_32 category));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysig_set_options
PROTOTYPE ((struct HyPortLibrary * portLibrary, U_32 options));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysig_protect
...
struct HyPortLibrary;
extern HY_CFUNC U_32 VMCALL hysig_set_async_signal_handler
PROTOTYPE ((struct HyPortLibrary * portLibrary, hysig_handler_fn handler,
	    void *handler_arg, U_32 flags));
struct HyPortLibrary;
extern HY_CFUNC U_32 VMCALL hysig_info
PROTOTYPE ((struct HyPortLibrary * portLibrary, void *info, U_32 category,
	    I_32 index, const char **name, void **value));

/* HySourceHySL*/
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hysl_lookup_name
PROTOTYPE ((struct HyPortLibrary * portLibrary, UDATA descriptor, char *name,
	    UDATA * func, const char *argSignature));
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hysl_close_shared_library
PROTOTYPE ((struct HyPortLibrary * portLibrary, UDATA descriptor));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysl_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hysl_open_shared_library
PROTOTYPE ((struct HyPortLibrary * portLibrary, char *name,
	    UDATA * descriptor, BOOLEAN decorate));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hysl_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));

/* HySourceHyStr*/
struct HyPortLibrary;
extern HY_CFUNC U_32 VMCALL hystr_vprintf
PROTOTYPE ((struct HyPortLibrary * portLibrary, char *buf, U_32 bufLen,
	    const char *format, va_list args));
struct HyPortLibrary;
extern HY_CFUNC U_32 VMCALL hystr_printf
PROTOTYPE ((struct HyPortLibrary * portLibrary, char *buf, U_32 bufLen,
	    const char *format, ...));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hystr_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hystr_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));

/* HySourceHyStrFTime*/
struct HyPortLibrary;
extern HY_CFUNC U_32 VMCALL hystrftime
PROTOTYPE ((struct HyPortLibrary * portLibrary, char *buf, U_32 bufLen,
	    const char *format));

/* HySourceHyTime*/
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hytime_usec_clock
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC U_64 VMCALL hytime_hires_clock
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC U_64 VMCALL hytime_hires_delta
PROTOTYPE ((struct HyPortLibrary * portLibrary, U_64 startTime, U_64 endTime,
	    UDATA requiredResolution));
struct HyPortLibrary;
extern HY_CFUNC U_64 VMCALL hytime_hires_frequency
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hytime_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_64 VMCALL hytime_current_time_millis
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hytime_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC UDATA VMCALL hytime_msec_clock
PROTOTYPE ((struct HyPortLibrary * portLibrary));

/* HySourceHyTTY*/
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hytty_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hytty_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hytty_err_printf
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *format, ...));
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hytty_get_chars
PROTOTYPE ((struct HyPortLibrary * portLibrary, char *s, UDATA length));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hytty_printf
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *format, ...));
struct HyPortLibrary;
extern HY_CFUNC IDATA VMCALL hytty_available
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hytty_vprintf
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *format,
	    va_list args));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hytty_err_vprintf
PROTOTYPE ((struct HyPortLibrary * portLibrary, const char *format,
	    va_list args));
...
extern HY_CFUNC void *VMCALL hyvmem_commit_memory
PROTOTYPE ((struct HyPortLibrary * portLibrary, void *address,
	    UDATA byteAmount, struct HyPortVmemIdentifier * identifier));
struct HyPortLibrary;
struct HyPortVmemIdentifier;
extern HY_CFUNC IDATA VMCALL hyvmem_decommit_memory
PROTOTYPE ((struct HyPortLibrary * portLibrary, void *address,
	    UDATA byteAmount, struct HyPortVmemIdentifier * identifier));
struct HyPortLibrary;
struct HyPortVmemIdentifier;
extern HY_CFUNC void *VMCALL hyvmem_reserve_memory
PROTOTYPE ((struct HyPortLibrary * portLibrary, void *address,
	    UDATA byteAmount, struct HyPortVmemIdentifier * identifier,
	    UDATA mode, UDATA pageSize));
struct HyPortLibrary;
extern HY_CFUNC void VMCALL hyvmem_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC UDATA *VMCALL hyvmem_supported_page_sizes
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
struct HyPortVmemIdentifier;
extern HY_CFUNC I_32 VMCALL hyvmem_free_memory
PROTOTYPE ((struct HyPortLibrary * portLibrary, void *address,
	    UDATA byteAmount, struct HyPortVmemIdentifier * identifier));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyvmem_startup
PROTOTYPE ((struct HyPortLibrary * portLibrary));

/* HySourcePort*/
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyport_shutdown_library
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibraryVersion;
extern HY_CFUNC UDATA VMCALL hyport_getSize
PROTOTYPE ((struct HyPortLibraryVersion * version));
struct HyPortLibraryVersion;
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyport_getVersion
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct HyPortLibraryVersion * version));
struct HyPortLibraryVersion;
extern HY_CFUNC I_32 VMCALL hyport_isCompatible
...
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyport_isFunctionOverridden
PROTOTYPE ((struct HyPortLibrary * portLibrary, UDATA offset));
struct HyPortLibraryVersion;
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyport_init_library
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct HyPortLibraryVersion * version, UDATA size));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyport_startup_library
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibraryVersion;
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hyport_create_library
PROTOTYPE ((struct HyPortLibrary * portLibrary,
	    struct HyPortLibraryVersion * version, UDATA size));

/* HySourceSockets*/
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysock_hostent_addrlist
PROTOTYPE ((struct HyPortLibrary * portLibrary, hyhostent_t handle,
	    U_32 index));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysock_getaddrinfo
PROTOTYPE ((struct HyPortLibrary * portLibrary, char *name,
	    hyaddrinfo_t hints, hyaddrinfo_t result));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysock_setopt_int
PROTOTYPE ((struct HyPortLibrary * portLibrary, hysocket_t socketP,
	    I_32 optlevel, I_32 optname, I_32 * optval));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysock_shutdown
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysock_hostent_aliaslist
PROTOTYPE ((struct HyPortLibrary * portLibrary, hyhostent_t handle,
	    char ***aliasList));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysock_fdset_init
PROTOTYPE ((struct HyPortLibrary * portLibrary, hysocket_t socketP));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysock_getaddrinfo_create_hints
PROTOTYPE ((struct HyPortLibrary * portLibrary, hyaddrinfo_t * result,
	    I_16 family, I_32 socktype, I_32 protocol, I_32 flags));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysock_connect_with_timeout
PROTOTYPE ((struct HyPortLibrary * portLibrary, hysocket_t sock,
	    hysockaddr_t addr, U_32 timeout, U_32 step, U_8 ** context));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysock_getpeername
PROTOTYPE ((struct HyPortLibrary * portLibrary, hysocket_t handle,
	    hysockaddr_t addrHandle));
struct HyPortLibrary;
extern HY_CFUNC const char *VMCALL hysock_error_message
PROTOTYPE ((struct HyPortLibrary * portLibrary));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysock_getnameinfo
PROTOTYPE ((struct HyPortLibrary * portLibrary, hysockaddr_t in_addr,
	    I_32 sockaddr_size, char *name, I_32 name_length, int flags));
struct HyPortLibrary;
extern HY_CFUNC I_32 VMCALL hysock_setopt_ipv6_mreq
PROTOTYPE ((struct HyPortLibrary * portLibrary, hysocket_t socketP,
...
#endif /* portlibraryprivatedefines_h */
